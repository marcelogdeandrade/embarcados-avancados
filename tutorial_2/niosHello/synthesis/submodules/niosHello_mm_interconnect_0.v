...
module niosHello_mm_interconnect_0 (
		...
		output wire [12:0] data_memory_s1_address,                         //                           data_memory_s1.address
		...
		output wire [13:0] program_memory_s1_address,                      //                        program_memory_s1.address
	...
	wire  [16:0] data_memory_s1_agent_m0_address;                                                    // data_memory_s1_agent:m0_address -> data_memory_s1_translator:uav_address
	...
	wire  [93:0] data_memory_s1_agent_rf_source_data;                                                // data_memory_s1_agent:rf_source_data -> data_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] data_memory_s1_agent_rsp_fifo_out_data;                                             // data_memory_s1_agent_rsp_fifo:out_data -> data_memory_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> data_memory_s1_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> data_memory_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // data_memory_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> data_memory_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> data_memory_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> data_memory_s1_agent:cp_endofpacket
	...
	wire  [16:0] leds_pio_s1_agent_m0_address;                                                       // leds_pio_s1_agent:m0_address -> leds_pio_s1_translator:uav_address
	...
	wire  [93:0] leds_pio_s1_agent_rf_source_data;                                                   // leds_pio_s1_agent:rf_source_data -> leds_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] leds_pio_s1_agent_rsp_fifo_out_data;                                                // leds_pio_s1_agent_rsp_fifo:out_data -> leds_pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> leds_pio_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> leds_pio_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // leds_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> leds_pio_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> leds_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> leds_pio_s1_agent:cp_endofpacket
	...
	wire  [16:0] keys_pio_s1_agent_m0_address;                                                       // keys_pio_s1_agent:m0_address -> keys_pio_s1_translator:uav_address
	...
	wire  [93:0] keys_pio_s1_agent_rf_source_data;                                                   // keys_pio_s1_agent:rf_source_data -> keys_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] keys_pio_s1_agent_rsp_fifo_out_data;                                                // keys_pio_s1_agent_rsp_fifo:out_data -> keys_pio_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> keys_pio_s1_agent:cp_data
	...
	wire  [16:0] program_memory_s1_agent_m0_address;                                                 // program_memory_s1_agent:m0_address -> program_memory_s1_translator:uav_address
	...
	wire  [93:0] program_memory_s1_agent_rf_source_data;                                             // program_memory_s1_agent:rf_source_data -> program_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] program_memory_s1_agent_rsp_fifo_out_data;                                          // program_memory_s1_agent_rsp_fifo:out_data -> program_memory_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> program_memory_s1_agent:cp_data
	...
	wire         data_memory_s1_agent_rp_valid;                                                      // data_memory_s1_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] data_memory_s1_agent_rp_data;                                                       // data_memory_s1_agent:rp_data -> router_004:sink_data
	wire         data_memory_s1_agent_rp_ready;                                                      // router_004:sink_ready -> data_memory_s1_agent:rp_ready
	wire         data_memory_s1_agent_rp_startofpacket;                                              // data_memory_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         data_memory_s1_agent_rp_endofpacket;                                                // data_memory_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         leds_pio_s1_agent_rp_valid;                                                         // leds_pio_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] leds_pio_s1_agent_rp_data;                                                          // leds_pio_s1_agent:rp_data -> router_005:sink_data
	wire         leds_pio_s1_agent_rp_ready;                                                         // router_005:sink_ready -> leds_pio_s1_agent:rp_ready
	wire         leds_pio_s1_agent_rp_startofpacket;                                                 // leds_pio_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         leds_pio_s1_agent_rp_endofpacket;                                                   // leds_pio_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [92:0] button_pio_s1_agent_rp_data;                                                        // button_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] keys_pio_s1_agent_rp_data;                                                          // keys_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] program_memory_s1_agent_rp_data;                                                    // program_memory_s1_agent:rp_data -> router_008:sink_data
	...
	wire         data_memory_s1_agent_rdata_fifo_src_valid;                                          // data_memory_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] data_memory_s1_agent_rdata_fifo_src_data;                                           // data_memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         data_memory_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_002:in_0_ready -> data_memory_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> data_memory_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> data_memory_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // data_memory_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> data_memory_s1_agent:rdata_fifo_sink_error
	wire         leds_pio_s1_agent_rdata_fifo_src_valid;                                             // leds_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] leds_pio_s1_agent_rdata_fifo_src_data;                                              // leds_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         leds_pio_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_003:in_0_ready -> leds_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> leds_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> leds_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // leds_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> leds_pio_s1_agent:rdata_fifo_sink_error
	...
	niosHello_mm_interconnect_0_router_003 router_008 (
	...
	niosHello_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
