...
# Memory: data_memory
MEM_0 := niosHello_data_memory
$(MEM_0)_NAME := data_memory
...
$(MEM_0)_END := 0x00116a5f
$(MEM_0)_SPAN := 0x00016a60
$(MEM_0)_HIERARCHICAL_PATH := data_memory
$(MEM_0)_WIDTH := 32
...
.PHONY: data_memory
data_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: program_memory
MEM_1 := niosHello_program_memory
$(MEM_1)_NAME := program_memory
...
$(MEM_1)_END := 0x000c0a3f
$(MEM_1)_SPAN := 0x00040a40
$(MEM_1)_HIERARCHICAL_PATH := program_memory
$(MEM_1)_WIDTH := 32
...
program_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
